      ...
      <div className="container border-top mt-5">
        <div className="row mt-5 mb-5">
          <div className="col-3 ">
            ...
            <div className="social-icon1 mb-3">
              <a href="">
            ...
            <div className="social-icon2 border-top">
              <a href="">
          ...
          <div className="footer-com col ">
            ...
            <br />
            <a href="">Fund transffooter-com er</a>
            <br />
            <a href="">MTF</a>
            <br />
        ...
        <div className="footer-info p-3 text-center">
          <a href="">NSE</a>
          <a href="">BSE</a>
          <a href="">MCX</a>
