  ...
  return (
    <div className="container">
      <div className="row mt-5">
        <h1 className="fs-2 pt-5 mt-5 text-center mb-5">
      ...
      <div
        ...
        style={{ lineHeight: "30px", fontSize: "large" }}
      >
        <div className="about-intro1 col-6 mt-5 text-muted">
          <p>
        ...
        <div className=" about-intro2 col-6 mt-5 text-muted">
          <p>
